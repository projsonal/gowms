...
func (h *Controller) Detail(c *fiber.Ctx) error {
	...
	return utils.OK(c, "data barang rusak yang detail berhasil diambil", b)
}
...
func (h *Controller) Create(c *fiber.Ctx) error {
	...
	if req.BarangID != nil {
		if _, err := h.barangRepo.FindByID(*req.BarangID); err != nil {
			return utils.Fail(c, fiber.StatusBadRequest, "Data barang tidak ditemukan", nil)
		}
	}
...
func (h *Controller) Update(c *fiber.Ctx) error {
	...
	b, err := h.repo.FindByID(id)
	if err != nil {
		return utils.Fail(c, fiber.StatusNotFound, " barang rusak tidak ditemukan", nil)
	}
